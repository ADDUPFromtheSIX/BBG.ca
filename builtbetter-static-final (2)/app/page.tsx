...
export default function BuiltBetterWebsite() {
  ...
  const requestEstimateSummary = useMemo(() => {
    return [
      `Estimate Request: ${estimate.label}`,
      `Budget Range: ${formatCurrency(estimate.low)} - ${formatCurrency(estimate.high)}`,
      `Project Type: ${selectedProject.label}`,
      `Sub Category: ${selectedSubCategory.label}`,
      `Job Type: ${selectedJob.label}`,
      `Scope: ${estimate.quantityLabel}`,
      `Rate: ${estimate.rateLabel}`,
      `Permit Allowance: ${permitsRequired === "yes" ? "Included" : "Excluded"}`,
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          >
            Condo Renovations. Design &amp; Build.
            <br />
            Outdoor Living.
          </motion.h1>
          <p className="mb-6 text-lg text-gray-200">
            Built Better Group specializes in high-end condo renovations, full design-build projects, and premium outdoor hardscaping across Toronto and the GTA.
          </p>
      ...
      <section className="bg-gray-950 px-5 py-16 text-white sm:px-8 sm:py-20">
        ...
        <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-3">
          {testimonials.map((item) => (
            <Card key={item.name} className="border border-gray-800 bg-black/40 text-white">
            ...
            <CardContent className="p-5 sm:p-8">
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  onClick={() => {
                    setProjectDetails(requestEstimateSummary);
      ...
      <section id="project-contact-form" className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        <h2 className="mb-3 text-center text-3xl font-bold">Start Your Project</h2>
        <p className="mb-8 text-center text-gray-600">
          Press <span className="font-semibold">Request This Estimate</span> above and we will preload the estimate details for you here.
        </p>
        <form action="https://formspree.io/f/maqapqqe" method="POST" className="grid gap-4">
          ...
          <Textarea
            name="details"
            placeholder="Press 'Request This Estimate' above to preload your project information here."
            className="min-h-40"
